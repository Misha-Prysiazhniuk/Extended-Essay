...
-I am really interested in a topic about AI security, as I've seen that it is possible to overcome the rules and policy of them. So I want to investigate on different prompt injection (jailbreaking) techniques for AI and discuss the theoretical solutions to secure the AI safety.

Why is this investigation worth doing?
(Explain what makes it significant, original, or valuable — what new insight might it add?)
